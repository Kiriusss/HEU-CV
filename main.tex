...
% 自定义颜色
\definecolor{primary_color}{RGB}{18, 86, 159}    % 蓝
...
% 学院
\newcommand{\school}{船舶工程学院 | College of Shipbuilding Engineering} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@hrbeu.edu.cn}{youremail@hrbeu.edu.com}
        \hspace{4em}
        % 手机号
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south, inner sep=0pt](footer) at (current page.south){
            \includegraphics[width=\paperwidth]{images/footer-darkgreen.jpg}
        };
        % 联系方式
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/logo2.jpg}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        \begin{minipage}[t]{0.5\textwidth}
            \textbf{姓\qquad 名}：君の名は
            
            \vspace{0.5em}
            \textbf{出生年月}：你的出生日期
        \end{minipage}
        \begin{minipage}[t]{0.35\textwidth}
            \textbf{性\qquad 别}：水下无人潜航器
        ...
        {\large \textbf{哈尔滨工业大学}}，本科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{哈尔滨工程大学}}，硕士 \hfill 2010年9月--2020年6月
        \begin{itemize}
        ...
        \vspace{0.5em}
        {\large \textbf{哈尔滨工程大学}}，博士 \hfill 2020年9月--至今
        \begin{itemize}
            \item 你的学院，你的专业，你的导师姓名\ 职称
    ...
    % 科研著作（研究生）
    This is One of Your Paper Published in Ocean Engineering.
    \begin{itemize}
        \item \textbf{Mingzi Nide}, Daoshi Nide. \hfill 发表于 \textbf{Ocean Engineering}（SCI-1区）
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \setlength{\itemsep}{0.5em}
            \item 熟练使用 Python、Matlab 等编程语言进行开发与仿真。
            \item 熟悉水下机器人的的设计与搭建。
